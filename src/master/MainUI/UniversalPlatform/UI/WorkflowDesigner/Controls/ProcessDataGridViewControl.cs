...
namespace MainUI.UniversalPlatform.UI.WorkflowDesigner.Controls
{
    ...
    public partial class ProcessDataGridViewControl : UserControl
    {
        ...
        /// 工作流步骤添加事件 - 自动刷新UI
        /// </summary>
        private void OnWorkflowStepAdded(ChildStepModel step)
        {
            try
            {
        ...
        /// 工作流步骤移除事件 - 自动刷新UI
        /// </summary>
        private void OnWorkflowStepRemoved(ChildStepModel step)
        {
            try
            {
        ...
        /// 获取或设置步骤列表
        /// </summary>
        public List<ChildStepModel> Steps
        {
            get
            {
        ...
        /// 添加步骤
        /// </summary>
        public void AddStep(ChildStepModel step)
        {
            if (_workflowState != null)
            {
        ...
        /// 获取选中的步骤
        /// </summary>
        public ChildStepModel GetSelectedStep()
        {
    ...
    /// 步骤事件参数
    /// </summary>
    public class StepEventArgs(ChildStepModel step) : EventArgs
    {
        public ChildStepModel Step { get; } = step;
    }

    /// <summary>
    /// 步骤配置事件参数
    /// </summary>
    public class StepConfigEventArgs(ChildStepModel step, int rowIndex) : EventArgs
    {
        public ChildStepModel Step { get; } = step;
